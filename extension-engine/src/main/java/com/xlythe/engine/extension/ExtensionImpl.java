...
class ExtensionImpl implements ExtensionInterface {
    ...
    @Override
    public void setTheme(String packageName) {
        setTheme(mObj, packageName);
    }
    ...
    private static void setTheme(Object extension, String packageName) {
        try {
            Class<?> viewExtractor = extension.getClass();

            Method m = viewExtractor.getDeclaredMethod("setTheme", String.class);
            m.invoke(extension, packageName);
        }
